...
def _seed_corp_codes(cache_dir) -> None:
    # Every tracked DART company must be resolved for dart_readiness.ready
    # to be True at all (see radar_service.radar_readiness) — matching
    # tests/test_radar_inbox_page.py's own fixture exactly. Extended
    # (2026-09-04) with the Core Issuer Expansion batch's 8 new DART
    # companies, alongside the original Samsung/SK Hynix pair.
