...
def test_run_scan_omits_candidate_repository_by_default(tmp_path, monkeypatch):
    ...
    def _fake_run_pipeline(client, companies, cache_dir, lookback_days=None, max_candidates_to_process=None, candidate_repository=None, scan_interval_minutes=None):
