...
class AgentStoreRepositoryProtocol(Protocol):
    ...
    def active_runs(self) -> tuple[AgentRun, ...]: ...
    def latest_heartbeat_at(self, run_id: str) -> str | None: ...
    ...
    def finish_job(self, job_id: str, *, state: str, now: str, last_error_code: str | None = None,
                   next_attempt_at: str | None = None, expected_worker: str | None = None) -> bool: ...
    ...
    def count_matching_decisions(self, **filters) -> int: ...
    def distinct_issuers(self) -> tuple[str, ...]: ...
    def distinct_event_types(self) -> tuple[str, ...]: ...
    ...
    def describe_database(self) -> tuple[int | None, tuple[str, ...]]: ...
...
class _AgentStoreRepository:
    ...
    def active_runs(self) -> tuple[AgentRun, ...]:
        return self.module.active_runs(self.conn)

    def latest_heartbeat_at(self, run_id: str) -> str | None:
        return self.module.latest_heartbeat_at(self.conn, run_id)
    ...
    def finish_job(self, job_id: str, **kwargs) -> bool:
        return self.module.finish_job(self.conn, job_id, **kwargs)
    ...
    def count_matching_decisions(self, **filters) -> int:
        return self.module.count_matching_decisions(self.conn, **filters)

    def distinct_issuers(self) -> tuple[str, ...]:
        return self.module.distinct_issuers(self.conn)

    def distinct_event_types(self) -> tuple[str, ...]:
        return self.module.distinct_event_types(self.conn)
    ...
    def describe_database(self) -> tuple[int | None, tuple[str, ...]]:
        return self.module.describe_database(self.conn)
