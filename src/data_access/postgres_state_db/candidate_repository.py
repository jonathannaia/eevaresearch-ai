...
def load_candidate_created_at(conn: psycopg.Connection, source: str) -> dict[str, str]:
    ...
    rows = conn.execute("SELECT id, created_at FROM candidates WHERE source = %s", (source,)).fetchall()
