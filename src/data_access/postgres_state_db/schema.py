...
# column, mirroring the SQLite backend's own V20 exactly: nullable, no
# default. Every pre-existing row reads back NULL ("provenance not
# recorded"), matching CandidateSignal.published_by's own None default —
# no historical publication is ever inferred to be human-reviewed. A
# nullable column with no default is a metadata-only ALTER on Postgres.
# Amended before first application anywhere (see design/AUTONOMOUS_
# RESEARCH_AGENT_PRODUCTION_READINESS_2026_09_17.md §1.4).
